...
urlpatterns = [
    ...
    path('nuevostatusgrado', views.statusgrado_view, name='crear_statusgrado'),
    ...
    path('consultarnombre', views.consultar_nombre, name='consultar_nombre'),
    ...
    path('consultatrabajogrado', views.consultar_trabajogrado, name='consultar_trabajogrado'),
    path('consultastatusgrado', views.consultar_statusgrado, name='consultar_statusgrado'),
